    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'glass py-3' : 'py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <a href="#home" className="font-display text-2xl font-bold gradient-text">AC</a>
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <a href="#" className="btn-primary px-5 py-2.5 rounded-lg font-medium flex items-center gap-2 text-white">
