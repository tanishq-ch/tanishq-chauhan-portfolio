        ...
        <div className={`fade-in ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div key={project.title} className={`glass rounded-2xl overflow-hidden card-hover scale-in ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: `${index * 0.1}s` }}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-4">
                    <a href={project.github} className="flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors" style={{ color: 'var(--muted)' }}>
                      <Icons.Github /> GitHub
                    </a>
                    <a href={project.demo} className="flex items-center gap-2 text-sm font-medium hover:text-secondary transition-colors" style={{ color: 'var(--muted)' }}>
