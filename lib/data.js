...
export const skillsData = {
  ...
  'Machine Learning & AI': ['TensorFlow', 'PyTorch', 'Scikit-learn', 'Keras', 'Gemini API'],
  'Data Analytics': ['Pandas', 'NumPy', 'Matplotlib', 'Seaborn', 'Plotly'],
  'Web Development': ['FastAPI', 'Flask', 'Streamlit', 'React', 'HTML/CSS'],
  'Cloud & Databases': ['AWS', 'MongoDB', 'PostgreSQL', 'Firebase'],
  'DevOps & Tools': ['Docker', 'Git', 'GitHub', 'Jupyter', 'VS Code']
};
